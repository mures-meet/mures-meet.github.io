...
const translations = {
  ro: {
	...
	"social.header": "Metode oficiale de contact",
	"social.info": "Pentru a afla detaliile meet-urilor, precum locația, data și ora meet-ului, există 2 metode:",
	"social.info1": "1. Urmărirea paginii oficiale <span style=\"font-family:'FerroRosso';\">Mureș Carmeet</span> de pe platforma preferată de socializare din cele de mai jos (este necesară trimiterea unui mesaj privat cu modelul mașinii pentru a fi adăugat în lista de Close Friends).",
	"social.info2": "2. Pentru cei care nu folosesc social media, prin completarea formularului din secțiunea de <a href='#contact-section' class=\"smoothscroll\" style=\"font-family:'SerpentineSansICG-BoldOblique';\">Contact</a>, ve-ți primii detaliile fiecărui meet printr-un mesaj pe <span class=\"bold\"><span class=\"wrap-icon icon-whatsapp\"></span> WhatsApp, Facebook Messenger sau SMS.</span>",
	...
	"social.insta-info": "Pe <span class=\"bold\"><span class=\"wrap-icon icon-instagram\"></span> Instagram</span>, meet-urile sunt anunțate la <span class=\"bold\">Private Story</span> pentru cei care urmăresc pagina <span style=\"font-family:'FerroRosso';\">Mureș Carmeet</span> și sunt incluși în lista de <span class=\"bold\">Close Friends</span>.",
	"social.fb-info": "Pe <span class=\"bold\"> <span class=\"wrap-icon icon-facebook-square\"></span> Facebook</span>, meet-urile sunt anunțate pe <span class=\"bold\">Story Privat</span> pentru <span class=\"bold\">prietenii apropiați.</span>",
	"wapp.info": "În cazul în care nu folosiți aplicațiile <span class=\"bold\"><span class=\"wrap-icon icon-instagram\"></span> Instagram</span> sau <span class=\"bold\"> <span class=\"wrap-icon icon-facebook-square\"></span> Facebook</span>, ne puteți contacta pe WhatsApp pe butonul de mai sus <span class=\"bold\">sau</span> la completarea formularului de contact de mai jos, <span class=\"bold\">veți primi pe <span class=\"wrap-icon icon-whatsapp\"></span> WhatsApp, Facebook Messenger sau prin SMS</span> detaliile despre fiecare meet precum  locația, data și ora.",
  ...
  en: {
	...
	"social.header": "Official contact methods",
	"social.info": "To find out the details of the meets, such as the location, date and time of the meet, there are 2 methods:",
	"social.info1": "1. Following the official <span style=\"font-family:'FerroRosso';\">Mures Carmeet</span> page on your preferred social media platform from the ones below (it's required to send us a private message with your car model to be added to the Close Friends list)",
	"social.info2": "2. For those who do not use social media, by filling out the form in the <a href='#contact-section' class=\"smoothscroll\" style=\"font-family:'SerpentineSansICG-BoldOblique';\">Contact</a> section, you will receive the details of each meet via a message on <span class=\"bold\"><span class=\"wrap-icon icon-whatsapp\"></span> WhatsApp, Facebook Messenger or SMS.</span>",
	"social.bio1": "Private local car meets and events,",
	"social.bio2": "based in Targu Mures, Romania📍",
	"social.bio3": "since 2023",
	"social.insta-info": "On <span class=\"bold\"><span class=\"wrap-icon icon-instagram\"></span> Instagram</span>, the meets are announced in the <span class=\"bold\">Private Story</span> for those who follow the <span style=\"font-family:'FerroRosso';\">Mures Carmeet</span> page and are included in the <span class=\"bold\">Close Friends</span> list.",
	"social.fb-info": "On <span class=\"bold\"> <span class=\"wrap-icon icon-facebook-square\"></span> Facebook</span>, the meets are announced in the <span class=\"bold\">Private Group</span> for those who are <span class=\"bold\">members of the group.</span>",
	"wapp.info": "In case you do not use the <span class=\"bold\"><span class=\"wrap-icon icon-instagram\"></span> Instagram</span> or <span class=\"bold\"> <span class=\"wrap-icon icon-facebook-square\"></span> Facebook</span> apps, you can contact us on WhatsApp through the button above <span class=\"bold\">or</span> by filling out the contact form below, <span class=\"bold\">you will receive via <span class=\"wrap-icon icon-whatsapp\"></span> WhatsApp, Facebook Messenger or SMS</span> the details about each meet such as location, date and time.",
	"contact.header": "Contact",
  ...
  hu: {
	...
	"social.header": "Hivatalos kapcsolattartási módok",
	"social.info": "A találkozók részleteinek, például a helyszín, dátum és idő megismeréséhez két módszer létezik:",
	"social.info1": "1. Kövesd a hivatalos <span style=\"font-family:'FerroRosso';\">Mureș Carmeet</span> oldalt a kedvenc közösségi média platformodon az alábbiak közül (szükséges, hogy küldj nekünk egy privát üzenetet az autód modelljével, hogy felvegyünk a Close Friends listára)",
	"social.info2": "2. Azok számára, akik nem használják a közösségi médiát, a <a href='#contact-section' class=\"smoothscroll\" style=\"font-family:'SerpentineSansICG-BoldOblique';\">Kapcsolat</a> szakaszban található űrlap kitöltésével megkapod a találkozók részleteit egy üzenetben a <span class=\"bold\"><span class=\"wrap-icon icon-whatsapp\"></span> WhatsApp, Facebook Messenger vagy SMS.</span>",
	"social.bio1": "Privát helyi autós találkozók és események,",
	"social.bio2": "Marosvásárhely-ben, Romániában📍",
	"social.bio3": "2023 óta",
	"social.insta-info": "Az <span class=\"bold\"><span class=\"wrap-icon icon-instagram\"></span> Instagram</span> platformon a találkozókat a <span class=\"bold\">Privát Story-ban</span> jelentik be azok számára, akik követik a <span style=\"font-family:'FerroRosso';\">Mureș Carmeet</span> oldalt és szerepelnek a <span class=\"bold\">Close Friends</span> listán.",
	"social.fb-info": "A <span class=\"bold\"> <span class=\"wrap-icon icon-facebook-square\"></span> Facebook</span> platformon a találkozókat a <span class=\"bold\">Privát Csoportban</span> jelentik be azok számára, akik a <span class=\"bold\">csoport tagjai.</span>",
	"wapp.info": "Ha nem használod az <span class=\"bold\">Instagram</span> vagy <span class=\"bold\">Facebook</span> alkalmazásokat, akkor a fenti gombon keresztül WhatsApp-on keresztül léphetsz kapcsolatba velünk <span class=\"bold\">vagy</span> a lenti kapcsolati űrlap kitöltésével, <span class=\"bold\">amelyen keresztül <span class=\"wrap-icon icon-whatsapp\"></span> WhatsApp-on, Facebook Messenger vagy SMS-ben</span> megkapod a találkozók részleteit, mint például a helyszín, dátum és idő.",
