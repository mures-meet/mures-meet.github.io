...
const translations = {
  ro: {
	...
	"socials.info2": "2. Pentru cei care nu folosesc social media, prin completarea formularului din secțiunea de <a href='#contact-section' class=\"smoothscroll\" style=\"font-family:'SerpentineSansICG-BoldOblique';\">Contact</a>, pentru a primii detaliile fiecărui meet printr-un mesaj pe <span class=\"wrap-icon icon-whatsapp\"></span>WhatsApp, Facebook Messenger sau SMS.",
	...
	"wapp.info": "În cazul în care nu folosiți aplicațiile <span class=\"bold\"><span class=\"wrap-icon icon-instagram\"></span> Instagram</span> sau <span class=\"bold\"> <span class=\"wrap-icon icon-facebook-square\"></span> Facebook</span>, ne puteți contacta pe <span class=\"bold\"><span class=\"wrap-icon icon-whatsapp\"></span>WhatsApp</span> pe butonul de mai sus cu un mesaj care să conțină modelul mașinii sau la completarea formularului de contact de mai jos, veți primi pe <span class=\"bold\"><span class=\"wrap-icon icon-whatsapp\"></span>WhatsApp, Facebook Messenger sau prin SMS</span> detaliile despre fiecare meet precum  locația, data și ora.",
  ...
  en: {
	...
	"socials.info2": "2. For those who do not use social media, by filling out the form in the <a href='#contact-section' class=\"smoothscroll\" style=\"font-family:'SerpentineSansICG-BoldOblique';\">Contact</a> section, you will receive the details of each meet via a message on <span class=\"wrap-icon icon-whatsapp\"></span>WhatsApp, Facebook Messenger or SMS.",
	...
	"wapp.info": "In case you do not use the <span class=\"bold\"><span class=\"wrap-icon icon-instagram\"></span> Instagram</span> or <span class=\"bold\"> <span class=\"wrap-icon icon-facebook-square\"></span> Facebook</span> apps, you can contact us on <span class=\"bold\"><span class=\"wrap-icon icon-whatsapp\"></span>WhatsApp</span> by pressing the button above with a message containing your car model or by filling out the contact form below, you will receive the details about each meet such as location, date and timeon <span class=\"bold\"><span class=\"wrap-icon icon-whatsapp\"></span>WhatsApp, Facebook Messenger or via SMS.</span>",
	"contact.header": "Contact",
  ...
  hu: {
	...
	"wapp.info": "Abban az esetben, ha nem használod az <span class=\"bold\"><span class=\"wrap-icon icon-instagram\"></span> Instagram</span> vagy a <span class=\"bold\"> <span class=\"wrap-icon icon-facebook-square\"></span> Facebook</span> alkalmazásokat, kapcsolatba léphetsz velünk a <span class=\"bold\"><span class=\"wrap-icon icon-whatsapp\"></span>WhatsApp</span> alkalmazáson keresztül a fenti gombra kattintva egy üzenettel, amely tartalmazza az autód modelljét, vagy kitöltve az alábbi kapcsolatfelvételi űrlapot, megkapod a találkozók részleteit, például a helyszínt, dátumot és időt a <span class=\"bold\"><span class=\"wrap-icon icon-whatsapp\"></span>WhatsApp, Facebook Messenger vagy SMS</span> alkalmazáson keresztül.",
